declare module 'matrix-js-sdk/lib/matrix' {

  // Type definitions for matrix-js-sdk 8.0
  ...
  //                 Nathan Pennie <https://github.com/kb1rd>
  // This includes modifications by Nathan Pennie to add support for various
  // APIs.
  ...
  export class DiscoveredClientConfig {
    ...
    ['m.homeserver']: {
      ...
      state: 'FAIL_PROMPT' | 'PROMPT';
      error?: string;
      base_url?: string;
    } | { state: 'SUCCESS'; error: undefined; base_url?: string; }
    ['m.identity_server']: {
      state: 'FAIL_ERROR';
      error: string;
      base_url: undefined;
  ...
  export namespace AutoDiscovery {
    export const ERROR_INVALID = 'Invalid homeserver discovery response'
    export const ERROR_GENERIC_FAILURE = 'Failed to get autodiscovery configuration from server'
    export const ERROR_INVALID_HS_BASE_URL = 'Invalid base_url for m.homeserver'
    export const ERROR_INVALID_HOMESERVER = 'Homeserver URL does not appear to be a valid Matrix homeserver'
    export const ERROR_INVALID_IS_BASE_URL = 'Invalid base_url for m.identity_server'
    export const ERROR_INVALID_IDENTITY_SERVER = 'Identity server URL does not appear to be a valid identity server'
    export const ERROR_INVALID_IS = 'Invalid identity server discovery response'
    export const ERROR_MISSING_WELLKNOWN = 'No .well-known JSON file found'
    export const ERROR_INVALID_JSON = 'Invalid JSON'
    export const ALL_ERRORS: string[]

    export const FAIL_ERROR = 'FAIL_ERROR'
    export const FAIL_PROMPT = 'FAIL_PROMPT'
    export const PROMPT = 'PROMPT'
    export const SUCCESS = 'SUCCESS'

    function findClientConfig(domain: string): Promise<DiscoveredClientConfig>;
  }
